...
const Slide10LStackMobile = dynamic(
  () => import("@/components/slides/Slide10LStack.mobile"),
  { ssr: false }
);
const Slide11MechanismMobile = dynamic(
  () => import("@/components/slides/Slide11Mechanism.mobile"),
  { ssr: false }
);
const Slide12CoreValueMobile = dynamic(
  () => import("@/components/slides/Slide12CoreValue.mobile"),
  { ssr: false }
);
const Slide15Part03Mobile = dynamic(
  () => import("@/components/slides/Slide15Part03.mobile"),
  { ssr: false }
);
const Slide13CompetitionMobile = dynamic(
...
const Slide16AdCreativeMobile = dynamic(
  () => import("@/components/slides/Slide16AdCreative.mobile"),
  { ssr: false }
);
const Slide17WorkLogicMobile = dynamic(
  () => import("@/components/slides/Slide17WorkLogic.mobile"),
  { ssr: false }
);
const Slide18VisionMobile = dynamic(
  () => import("@/components/slides/Slide18Vision.mobile"),
  { ssr: false }
);
const Slide19LandscapeMobile = dynamic(
  () => import("@/components/slides/Slide19Landscape.mobile"),
  { ssr: false }
);
