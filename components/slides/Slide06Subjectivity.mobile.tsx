...
export default function Slide06SubjectivityMobile({ step }: SlideProps) {
  return (
    <svg viewBox="0 0 720 1280" xmlns="http://www.w3.org/2000/svg">
      <SlideBaseMobile chapter="04 · 人的主体性" title="同样的模型，不同的人" page={4}>
        <Step show={step >= 2}>
          <g transform="translate(20, 420) scale(1.05)">
            <rect
              x="44"
              y="83"
              width="118"
